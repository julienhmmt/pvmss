...
import type { VMCreateSettings, VMCreateRequest, VMCreateResponse } from '$lib/types/vm-create';
...
export async function createVM(request: VMCreateRequest): Promise<VMCreateResponse> {
